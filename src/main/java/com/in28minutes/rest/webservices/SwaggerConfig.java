...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Joao Carlos", "joaocarlos.com",
			"jcarlos.vale@gmail.com");
	@SuppressWarnings("rawtypes")
	public static final ApiInfo DEFAULT = new ApiInfo("Awesonme Api Documentation", "Awesome Api Documentation", "1.0",
